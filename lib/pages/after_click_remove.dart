...
class AfterClickRemove extends StatelessWidget {
  @override
          ...
          children: [
            SizedBox(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    margin: EdgeInsets.fromLTRB(1, 0, 2, 163),
                    child: Container(
                      decoration: BoxDecoration(
                        color: Color(0xFFEFF3F9),
                      ),
                      child: Container(
                        padding: EdgeInsets.fromLTRB(23, 15.7, 37, 39),
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Container(
                              margin: EdgeInsets.fromLTRB(8.1, 0, 0, 20),
                              child: Row(
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Container(
                  ...
                  child: Text(
                    'Choose the subject you want to Remove',
                    style: GoogleFonts.getFont(
                      'Poppins',
                      fontWeight: FontWeight.w700,
                      fontSize: 16,
