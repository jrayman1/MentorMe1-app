...
class AfterRemoveEditPlan extends StatelessWidget {
  @override
            ...
            SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(3, 0, 0, 100),
                    decoration: BoxDecoration(
                      color: Color(0xFFEFF3F9),
                      boxShadow: [
                        BoxShadow(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Container(
                              padding: EdgeInsets.fromLTRB(12, 8, 11.9, 9),
                              child: Text(
                                'Remove',
                                style: GoogleFonts.getFont(
                                  'Poppins',
                ...
                child: SizedBox(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          margin: EdgeInsets.fromLTRB(0, 0, 0, 157),
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(20),
